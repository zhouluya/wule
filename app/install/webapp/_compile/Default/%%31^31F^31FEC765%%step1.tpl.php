<?php /* Smarty version 2.6.26, created on 2020-03-02 12:20:59
			...
			<div class="rules">
			 ...
			 <h1 style="text-align:center;">环境检测</h1>
               ...
               <table class="table">
                ...
                <tbody>
                    <?php $_from = $this->_tpl_vars['functions']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['f1'] = array('total' => count($_from), 'iteration' => 0);
...
?>
                        <tr>
                            ...
                            <td><i class="iconfont ico-<?php echo $this->_tpl_vars['item'][4]; ?>
">&nbsp;</i><?php echo $this->_tpl_vars['item'][3]; ?>
</td>       
                        </tr>
                ...
                <table class="table">
                    ...
                    <tbody>
                     ...
                     <?php $_from = $this->_tpl_vars['files']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['f1'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['f1']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['item']):
        $this->_foreach['f1']['iteration']++;
?>
                        <tr>
                            ...
                            <td><i class="iconfont ico-<?php echo $this->_tpl_vars['item'][2]; ?>
">&nbsp;</i><?php echo $this->_tpl_vars['item'][1]; ?>
</td>   
                        </tr>
                    <?php endforeach; endif; unset($_from); ?>
                </tbody>
            ...
            <table class="table">
                ...
                <tbody>
                    <?php $_from = $this->_tpl_vars['func']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['f1'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['f1']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['item']):
        $this->_foreach['f1']['iteration']++;
?>
