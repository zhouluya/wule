...
<div id="addpro" class="pd-20" style="background-color: white;">
	...
	<form name="form1" id="form1" class="form form-horizontal" style="margin-bottom: 10px;padding: 10px 10px 0 10px !important;" method="post" enctype="multipart/form-data" >
        <div class="row cl">
        ...
        <div class="row cl" >
			...
			<div class="formControls col-xs-8 col-sm-9">
				 <div  id="setlevel">
                    <div class="manlevel">
                        <input type="number" max="50" min="2"  step=1  class="input-text" value="" name="min_man1" style="width:60px;" onkeyup="onkeyup1(this)">&nbsp;&nbsp;人团&nbsp;&nbsp;
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"  style="margin-top: 9px;padding-right: 0px!important;height: 36px;line-height: 36px;"><span class="c-red">*</span>结束时间：</label>
			<div class="formControls col-xs-8 col-sm-9">
