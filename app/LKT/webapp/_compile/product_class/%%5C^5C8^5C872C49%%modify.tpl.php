<?php /* Smarty version 2.6.26, created on 2020-03-03 19:06:04
...
<div class="pd-20">
    <form name="form1" action="index.php?module=product_class&action=modify" class="form form-horizontal" method="post" enctype="multipart/form-data" onsubmit="return removeDisable()">
        <input type="hidden" name="cid" value="<?php echo $this->_tpl_vars['cid_r']; ?>
" />
...
" >
        ...
        <div class="row cl">
            ...
            <div class="formControls col-4">
                <input type="text" class="input-text" name="pname" value="<?php echo $this->_tpl_vars['pname']; ?>
" datatype="*6-18" style="width: 260px;">
            </div>
            <div class="col-4"> </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-6"> 
                <?php if ($this->_tpl_vars['img'] != ''): ?>
                    <img id="thumb_url" class="cimage" src='<?php echo $this->_tpl_vars['uploadImg']; ?>
<?php echo $this->_tpl_vars['img']; ?>
' style="height:60px;width:60px;">
                <?php else: ?>
                    <img id="thumb_url" class="cimage" src='<?php echo $this->_tpl_vars['uploadImg']; ?>
noimg.jpg' style="height:60px;width:60px;">
                <?php endif; ?>
                <input type="hidden"  id="picurl" name="image" datatype="*" nullmsg="请选择图片"/> 
                <input type="hidden" name="oldpic" value="<?php echo $this->_tpl_vars['img']; ?>
" >
                <div>图片尺寸:60*60</div>
            </div>
            <div class="col-4"> </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-6"> 
                <img id="thumb_urlbg" class="cbg" src="<?php echo $this->_tpl_vars['uploadImg']; ?>
<?php if ($this->_tpl_vars['bg'] != ''): ?><?php echo $this->_tpl_vars['bg']; ?>
<?php else: ?>noimg.jpg<?php endif; ?>" style="height:145px;width:220px">
                <input type="hidden"  id="picurlbg" name="bg" datatype="*" nullmsg="请选择图片"/> 
                <input type="hidden" name="oldpicbg" value="<?php echo $this->_tpl_vars['bg']; ?>
" >
        ...
        <div class="row cl" style="display: none;">
            ...
            <div class="formControls col-4">
                <input type="text" class="input-text" name="sort" value="<?php echo $this->_tpl_vars['sort']; ?>
" datatype="*6-18" style="width: 260px;">
            </div>
            <div class="col-4"> </div>
        </div>
...
;
var level = <?php echo $this->_tpl_vars['level']; ?>
;
 var pic = $("#pic").val();
<?php echo '
