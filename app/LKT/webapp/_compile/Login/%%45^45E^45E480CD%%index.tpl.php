<?php /* Smarty version 2.6.26, created on 2020-03-02 12:23:37
    ...
    <form name="form1" action="index.php?module=Login" class="form form-horizontal" method="post"   enctype="multipart/form-data" >
        <div class="page_login">
            <div class='login_title'>
                ...
                <p style="color: #fff;font-size: 30px;">吾乐管理系统</p>
                <p style="font-size: 14px; color: #fff;">Wule E-commerce Management System</p>
            </div>
