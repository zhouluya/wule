<?php /* Smarty version 2.6.26, created on 2020-03-03 18:53:29
...
" placeholder="请设置商品的默认售价" >
            ...
            <div class="row cl">
                ...
                <div class="formControls col-4" style="width: 26.8%;">
                    <input class="input-text" style="width:300px;" type="number" name="initial[leve1]" onkeypress="return noNumbers(event)" min="0"  step="0.01"  value="<?php echo $this->_tpl_vars['initial']->leve1; ?>
" placeholder="请设置一级佣金：" >
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-4" style="width: 26.8%;">
                    <input class="input-text" style="width:300px;" type="number" name="initial[leve2]" onkeypress="return noNumbers(event)" min="0"  step="0.01"  value="<?php echo $this->_tpl_vars['initial']->leve2; ?>
" placeholder="请设置二级佣金：" >
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-4" style="width: 26.8%;">
                    <input class="input-text" style="width:300px;" type="number" name="initial[leve3]" onkeypress="return noNumbers(event)" min="0"  step="0.01"  value="<?php echo $this->_tpl_vars['initial']->leve3; ?>
" placeholder="请设置三级佣金：" >
                </div>
            </div>
...
" name="volume" id="volumeId">
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">详细内容1：</label>
