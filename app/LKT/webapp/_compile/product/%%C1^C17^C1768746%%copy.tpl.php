<?php /* Smarty version 2.6.26, created on 2020-03-03 19:06:32
         compiled from copy.tpl */ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="formDivSD">
            <div class="formContentSD">
                <div class="formListSD">
                    ...
                    <div class="formInputSD"><input type="number" name="initial[cbj]" onkeypress="return noNumbers(event)" min="0" step="0.01" onblur="set_cbj(this);" value="<?php echo $this->_tpl_vars['initial']->cbj; ?>
" placeholder="请设置商品的默认成本价" ></div>
                </div>
...
" placeholder="请设置商品的默认售价" ></div>
                ...
                <div class="formListSD">
                    ...
                    <div class="formInputSD"><input type="number" name="initial[kucun]" oninput="value=value.replace(/[^\d]/g,'')" min="0" step="1" onblur="set_kucun(this);" value="<?php echo $this->_tpl_vars['initial']->kucun; ?>
" placeholder="请设置商品的默认库存" ></div>
                </div>
...
?>
                                <input type="hidden" name="imgurls[]" value="<?php echo $this->_tpl_vars['item']->product_url; ?>
" />
