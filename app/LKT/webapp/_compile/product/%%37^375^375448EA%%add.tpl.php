<?php /* Smarty version 2.6.26, created on 2020-03-04 04:08:10
            ...
            <div class="formContentSD">
                <div class="formListSD">
                    ...
                    <div class="formInputSD">
                        <input type="number" name="initial[cbj]" onkeypress="return noNumbers(event)" min="0" step="0.01" onblur="set_cbj(this);" value="<?php echo $this->_tpl_vars['initial']->cbj; ?>
" placeholder="请设置商品的默认成本价" >
                    </div>
                </div>
                <div class="formListSD">
                    <div class="formTextSD"><span class="must">*</span><span>原价：</span></div>
                    <div class="formInputSD"><input type="number" name="initial[yj]" onkeypress="return noNumbers(event)" min="0" step="0.01" onblur="set_yj(this);" value="<?php echo $this->_tpl_vars['initial']->yj; ?>
" placeholder="请设置商品的默认原价" ></div>
                </div>
                <div class="formListSD">
                    <div class="formTextSD"><span class="must">*</span><span>售价：</span></div>
                    <div class="formInputSD"><input type="number" name="initial[sj]" onkeypress="return noNumbers(event)" min="0" step="0.01" onblur="set_sj(this);" value="<?php echo $this->_tpl_vars['initial']->sj; ?>
" placeholder="请设置商品的默认售价" ></div>
                </div>
                <div class="formListSD">
                    <div class="formTextSD"><span class="must">*</span><span>一级佣金：</span></div>
                    <div class="formInputSD"><input type="number" name="initial[leve1]" onkeypress="return noNumbers(event)" min="0" step="0.01"  value="<?php echo $this->_tpl_vars['initial']->leve1; ?>
" placeholder="请设置一级佣金" ></div>
                </div>
                <div class="formListSD">
                    <div class="formTextSD"><span class="must">*</span><span>二级佣金：</span></div>
                    <div class="formInputSD"><input type="number" name="initial[leve2]" onkeypress="return noNumbers(event)" min="0" step="0.01"  value="<?php echo $this->_tpl_vars['initial']->leve2; ?>
" placeholder="请设置二级佣金" ></div>
                </div>
                <div class="formListSD">
                    <div class="formTextSD"><span class="must">*</span><span>三级佣金：</span></div>
                    <div class="formInputSD"><input type="number" name="initial[leve3]" onkeypress="return noNumbers(event)" min="0" step="0.01"  value="<?php echo $this->_tpl_vars['initial']->leve3; ?>
" placeholder="请设置二级佣金" ></div>
                </div>
...
"><?php echo $this->_tpl_vars['item1']->name; ?>
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">详细内容611：</label>
            <div class="formControls col-xs-8 col-sm-10">
...
<?php echo '"
            var leve4 = "'; ?>
<?php echo $this->_tpl_vars['data']['leve4']; ?>
<?php echo '"
            var leve5 = "'; ?>
<?php echo $this->_tpl_vars['data']['leve5']; ?>
<?php echo '"
            var listA = [
