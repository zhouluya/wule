<?php /* Smarty version 2.6.26, created on 2020-03-04 19:39:03
...
" placeholder="请设置商品的默认售价" disabled>
        ...
        <div class="row cl">
            <label class="form-label col-2"><span class="c-red">*</span>一级佣金：</label>
            <div class="formControls col-4" style="width: 26.8%;">
                <input class="input-text" style="width:300px;" type="number" name="initial[leve1]" onkeypress="return noNumbers(event)" min="0"  step="0.01"  value="<?php echo '<?php'; ?>
 echo $this->_tpl_vars['initial']->leve1; <?php echo '?>'; ?>

" placeholder="请设置一级佣金：" >
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-2"><span class="c-red">*</span>二级佣金：</label>
            <div class="formControls col-4" style="width: 26.8%;">
                <input class="input-text" style="width:300px;" type="number" name="initial[leve2]" onkeypress="return noNumbers(event)" min="0"  step="0.01"  value="<?php echo '<?php'; ?>
 echo $this->_tpl_vars['initial']->leve2; <?php echo '?>'; ?>

" placeholder="请设置二级佣金：" >
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-2"><span class="c-red">*</span>三级佣金：</label>
            <div class="formControls col-4" style="width: 26.8%;">
                <input class="input-text" style="width:300px;" type="number" name="initial[leve3]" onkeypress="return noNumbers(event)" min="0"  step="0.01"  value="<?php echo '<?php'; ?>
 echo $this->_tpl_vars['initial']->leve3; <?php echo '?>'; ?>
...
" name="volume" id="volumeId" disabled>
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">详细内容3：</label>
