<?php /* Smarty version 2.6.26, created on 2020-03-02 12:32:14
...
" id="pagesize" />
            ...
            <input type="text" name="cart_id" size='8' value="<?php echo $this->_tpl_vars['cart_id']; ?>
" id="" placeholder="菜单id" autocomplete="off" style="width:200px" class="input-text">
