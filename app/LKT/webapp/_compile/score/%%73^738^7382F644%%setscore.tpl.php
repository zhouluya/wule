<?php /* Smarty version 2.6.26, created on 2020-03-02 12:32:21
         compiled from setscore.tpl */ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="page-container" style="padding-top: 0px;">
    ...
    <form name="form1" action="" class="form form-horizontal" method="post"   enctype="multipart/form-data" >
        <div id="tab-system" class="HuiTab">
            ...
            <input type="hidden" name="returnbili" value="<?php echo $this->_tpl_vars['bili']; ?>
" />
            <input type="hidden" name="returnbuy" value="<?php echo $this->_tpl_vars['res']; ?>
" />
