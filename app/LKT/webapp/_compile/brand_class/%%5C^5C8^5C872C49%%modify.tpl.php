<?php /* Smarty version 2.6.26, created on 2020-03-03 19:07:16
...
<div class="pd-20">
    <form name="form1" action="index.php?module=brand_class&action=modify" class="form form-horizontal" method="post" enctype="multipart/form-data" >
        <input type="hidden" name="cid" value="<?php echo $this->_tpl_vars['brand_id']; ?>
" />
...
" id="uploadImg">
        <div class="row cl">
            ...
            <div class="formControls col-4">
                <input type="text" class="input-text" name="pname" id="pname" value="<?php echo $this->_tpl_vars['brand_name']; ?>
" datatype="*6-18" style="width: 260px; "  disabled>
            </div>
            <div class="col-4"> </div>
        </div>
        <div class="row cl">
...
<?php echo $this->_tpl_vars['brand_pic']; ?>
' style="height:100px;width:150px;" >
                <input type="hidden"  id="picurl" name="image" datatype="*" nullmsg="请选择图片"/> 
                <input type="hidden" name="oldpic" value="<?php echo $this->_tpl_vars['brand_pic']; ?>
" id="oldpic">
        ...
        <div class="row cl">
            <label class="form-label col-4"><span class="c-red" ></span>所属国家/市：222</label>
            <div class="formControls col-6">
                <input type="text" class="input-text" name="producer" id="producer" datatype="*6-18" style="width: 260px;" value="<?php echo $this->_tpl_vars['producer']; ?>
">
            </div>
            <div class="col-4"></div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-6">
                <input type="text" class="input-text" name="sort" id="sort" datatype="*6-18" value="<?php echo $this->_tpl_vars['sort']; ?>
" style="width: 260px;">
            </div>
            <div class="col-4"></div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-6">
                <input type="text" class="input-text" name="remarks" id="remarks" datatype="*6-18" style="width: 260px;" value="<?php echo $this->_tpl_vars['remarks']; ?>
">
            </div>
            <div class="col-4"></div>
        </div>
