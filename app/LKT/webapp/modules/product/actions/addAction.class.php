...
class addAction extends Action
{
    ...
    public function getDefaultView()
    {
        ...
        $volume = $request->getParameter('volume'); //拟定销量
        $leve1 = $request->getParameter('leve1'); //一级佣金
        $leve2 = $request->getParameter('leve2'); //二级佣金
        $leve3 = $request->getParameter('leve3'); //三级佣金
        ...
        $request->setAttribute('leve1', $leve1 ? $leve1 : '0');//一级佣金
        $request->setAttribute('leve2', $leve2 ? $leve2 : '0');//二级佣金
        $request->setAttribute('leve3', $leve3 ? $leve3 : '0');//三级佣金
    ...
    public function execute()
    {
        ...
        $sql = "insert into lkt_product_list(product_title,subtitle,product_class,brand_id,weight,imgurl,content,num,s_type,add_date,volume,freight,initial,status,leve,leve1,leve2,leve3) " .
            "values('$product_title','$subtitle','$product_class','$brand_id','$weight','$image','$content','$z_num','$type',CURRENT_TIMESTAMP,'$volume','$freight','$initial','2',$leve,'$leve1','$leve2','$leve3')";
