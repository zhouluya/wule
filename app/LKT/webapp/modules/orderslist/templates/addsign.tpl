...
<nav class="breadcrumb">
                    ...
                    {foreach from=$pro item=item name=f1}
                        ...
                        {if $item->express_id ==''}
                            <tr >
                                ...
                                <td>{$item->p_name}</td>
                                <td class="center">
                                    <img class='pimg' src="{$uploadImg}{$item->img}" style="margin-right: 20px;margin-left: 15px;" width="50" height="50"/>
                                </td>
        ...
        <div class="" style="z-index: 1333;">
            <div class="modal-content radius">
                ...
                <div class="modal-body">
                    ...
                    <form name="Ship-form" id="Ship-form" class="form form-horizontal" method="post" enctype="multipart/form-data">
                        <div class="row cl">
            ...
            <form id="from33" class="form form-horizontal" id="form-category-add">
                ...
                <div class="row cl">
                    <div class="col-9 " style="margin-left:40%">
                        <input class="qd closeMask" type="button" onclick="pushFromData()" value="提交">
                    </div>
                </div>
    ...
    <script type="text/javascript">
        ...
        $.ajax({
            ...
            type:"post",
            data:{sNo:id,trade:3,express:express,courier_num:courier_num,otype:otype,express_name:express_name,ids:ids},
            dataType:"json",
