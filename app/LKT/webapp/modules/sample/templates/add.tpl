        ...
        <div class="formDivSD">
            <div class="formContentSD">
                ...
                <div class="formListSD">
                    ...
                    <div class="formInputSD"><input type="number" name="initial[leve1]" onkeypress="return noNumbers(event)" min="0" step="0.01" onblur="set_yj(this);" value="<?php echo $this->_tpl_vars['initial']->leve1; ?>
" placeholder="请设置一级佣金" ></div>
                </div>
                <div class="formListSD">
                    <div class="formTextSD"><span class="must">*</span><span>二级佣金</span></div>
                    <div class="formInputSD"><input type="number" name="initial[leve2]" onkeypress="return noNumbers(event)" min="0" step="0.01" onblur="set_yj(this);" value="<?php echo $this->_tpl_vars['initial']->leve2; ?>
" placeholder="请设置二级佣金" ></div>
                </div>
                <div class="formListSD">
                    <div class="formTextSD"><span class="must">*</span><span>三级佣金</span></div>
                    <div class="formInputSD"><input type="number" name="initial[leve3]" onkeypress="return noNumbers(event)" min="0" step="0.01" onblur="set_yj(this);" value="<?php echo $this->_tpl_vars['initial']->leve3; ?>
" placeholder="请设置三级佣金" ></div>
                </div>
                <div class="formListSD">
    ...
    background-color: black;">
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">详细内容7：</label>
            <div class="formControls col-xs-8 col-sm-10">
